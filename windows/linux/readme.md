...
![Move programming files from Windows into WSL Linux](./.screenshots/warning.png)
...
![Enable Virtualzation for AMD on Asus](./.screenshots/uefi-asus-v12n-amd.png)

### `UEFI` ASUS motherboard Intel CPU

![Enable Virtualzation for Intel on Asus](./.screenshots/uefi-asus-v12n-intel.png)
...
![open-the-terminal](./.screenshots/open-terminal.png)
