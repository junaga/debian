...
_gh_issue_comment()
{
    ...
    flags+=("--body-file=")
    two_word_flags+=("--body-file")
    two_word_flags+=("-F")
    local_nonpersistent_flags+=("--body-file")
    local_nonpersistent_flags+=("--body-file=")
    local_nonpersistent_flags+=("-F")
    flags+=("--editor")
    flags+=("-e")
...
_gh_issue_list()
{
    ...
    flags+=("--json=")
    two_word_flags+=("--json")
    flags_with_completion+=("--json")
    flags_completion+=("__gh_handle_go_custom_completion")
...
_gh_issue_transfer()
{
    last_command="gh_issue_transfer"
...
_gh_repo_list()
{
    ...
    flags+=("--fork")
    local_nonpersistent_flags+=("--fork")
    flags+=("--jq=")
    two_word_flags+=("--jq")
    two_word_flags+=("-q")
    local_nonpersistent_flags+=("--jq")
...
_gh_run_view()
{
    ...
    flags+=("--exit-status")
    local_nonpersistent_flags+=("--exit-status")
    flags+=("--job=")
    two_word_flags+=("--job")
    two_word_flags+=("-j")
    ...
    flags+=("--log-failed")
    local_nonpersistent_flags+=("--log-failed")
    flags+=("--verbose")
    flags+=("-v")
...
{
    last_command="gh_workflow_disable"
...
_gh_workflow_enable()
{
    last_command="gh_workflow_enable"
