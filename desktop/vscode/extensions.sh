...
inst eric-blanquer.ansi-automatic-clean-viewer # https://marketplace.visualstudio.com/items?itemName=eric-blanquer.ansi-automatic-clean-viewer
inst esbenp.prettier-vscode # https://marketplace.visualstudio.com/items?itemName=esbenp.prettier-vscode
inst Vue.volar # https://marketplace.visualstudio.com/items?itemName=Vue.volar
inst LeonardSSH.vscord # https://marketplace.visualstudio.com/items?itemName=LeonardSSH.vscord
