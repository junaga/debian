...
-- Multiple windows use one-third-width columns on a horizontal tape.
-- Additional columns retain their width beyond the monitor edge.
--
--       visible workspace
-- ┌─────────┬─────────┬─────────┐
-- │    1    │    2    │    3    │ → 4 …
...
hl.bind(mainMod .. " + SHIFT + W", hl.dsp.exec_cmd("hyprshutdown"))
